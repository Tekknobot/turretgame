...
public class CrossFadeMusicManager : MonoBehaviour
  {
        ...
        [System.NonSerialized] private AudioSource musicSourceA;
        [System.NonSerialized] private AudioSource musicSourceB;
        ...
        [System.NonSerialized] private AudioClip targetAudioClip;
        ...
        void Update()
        {
            Lerp(ActiveAudioSource, ActiveAudioSource.clip ? targetVolume : 0, 0.1f);
            Lerp(FadingAudioSource, 0, 0.1f);
